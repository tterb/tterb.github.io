...
gulp.task('watch', function() {
  gulp.watch(['src/sass/*.scss','src/sass/**/*.scss'], ['sass','jekyll-rebuild']);
  ...
  gulp.watch(['**/*.html', '_layouts/*.html', '_includes/*.html', '_posts/*', 'assets/css/main.css'], ['jekyll-rebuild']);
  // gulp.watch(['_site/src/**/*.*', '_site/assets/**/*.*','assets/css/main.css']).on('change', browserSync.reload);
});
